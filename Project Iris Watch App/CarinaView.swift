          ...
          HStack {
            if isBulletinReady && !bulletinPackage.isEmpty {
              NavigationLink(destination: {
                ...
                Label("Carina.bulletin.\(bulletinDecoded.count)", systemImage: "pin.fill")
              })
            }
            Spacer()
            NavigationLink(destination: {
...
public let carinaStates: [LocalizedStringKey] = ["Carina.state.unmarked", "Carina.state.work-as-intended", "Carina.state.unable-to-fix", "Carina.state.combined", "Carina.state.shelved", "Carina.state.fixing", "Carina.state.fixed-in-future-versions", "Carina.state.fixed", "Carina.info.load", "Carina.state.cannot-reappear", "Carina.state.unrelated", "Carina.state.require-more-details"]
public let carinaStateDescription: [LocalizedStringKey] = ["Carina.state.unmarked.description", "Carina.state.work-as-intended.description", "Carina.state.unable-to-fix.description", "Carina.state.combined.description", "Carina.state.shelved.description", "Carina.state.fixing.description", "Carina.state.fixed-in-future-versions.description", "Carina.state.fixed.description", "Carina.info.load", "Carina.state.cannot-reappear.description", "Carina.state.unrelated.description", "Carina.state.require-more-details.description"]
public let carinaStateColors = [Color.secondary, Color.red, Color.red, Color.red, Color.orange, Color.orange, Color.orange, Color.green, Color.secondary, Color.red, Color.red, Color.orange]
public let carinaStateIcons: [String] = ["minus", "curlybraces", "xmark", "arrow.triangle.merge", "books.vertical", "hammer", "clock.badge.checkmark", "checkmark", "ellipsis", "questionmark", "bolt.horizontal", "arrowshape.turn.up.backward.badge.clock"]
public let carinaTypes: [LocalizedStringKey] = ["Carina.type.function", "Carina.type.interface", "Carina.type.texts", "Carina.type.suggestion", ]
public let carinaPlaces: [LocalizedStringKey] = ["Carina.place.about", "Carina.place.bookmarks", "Carina.place.carina-feedback", "Carina.place.history-and-privacy", "Carina.place.passcode", "Carina.place.search", "Carina.place.tips", "Carina.place.other"]
