...
struct SettingsView: View {
  ...
  @AppStorage("longPressButtonAction") var longPressButtonAction = 2
      ...
      Section("Settings.interface") {
        ...
        if #available(watchOS 10.0, *) {
          Toggle(isOn: $isBookmarkCounterDisplayed, label: {
            Label("Settings.interface.display-bookmarks-counter", systemImage: "bookmark")
          })
        }
      }
